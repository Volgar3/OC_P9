...
python --version
```
*Si vous n'avez pas python sur votre ordinateur, vous pouvez l'installer via [Microsoft Store](https://apps.microsoft.com/store/search/python) ou via [python.org](https://www.python.org/downloads/).*
